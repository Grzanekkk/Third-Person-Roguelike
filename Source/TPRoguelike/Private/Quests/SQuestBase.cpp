...
//{
//	for (TObjectPtr<USObjectiveBase> ActiveObjective : ObjectivesGoals)
//	{
...
//	{
//		ObjectivesGoals.Add(NewObjectiveInstance);
//
...
////	for (TObjectPtr<USObjectiveBase> Objective : ObjectivesGoals)
////	{
////		if (Objective)
////		{
...
//	DOREPLIFETIME(USQuestBase, ObjectivesGoals);
//}